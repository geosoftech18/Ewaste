...
export function generateQuickPickupEmail(data: {
  ...
  const formattedDate = data.preferredDate ? new Date(data.preferredDate).toLocaleDateString('en-IN', {
    weekday: 'long',
    year: 'numeric',
    month: 'long',
    day: 'numeric'
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <table role="presentation" style="width: 100%; border-collapse: collapse; margin-bottom: 30px;">
                ...
                <tr>
                  <td style="padding: 12px 0; border-bottom: 1px solid #e5e7eb;">
                    <strong style="color: #374151; font-size: 14px; display: inline-block; width: 140px;">Date:</strong>
                    <span style="color: #1f2937; font-size: 14px;">${formattedDate}</span>
                  </td>
                </tr>
                <tr>
                  <td style="padding: 12px 0;">
                    <strong style="color: #374151; font-size: 14px; display: inline-block; width: 140px;">Time:</strong>
                    <span style="color: #1f2937; font-size: 14px;">${data.preferredTime || 'Not specified'}</span>
                  </td>
                </tr>
              </table>
              ...
              <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; padding: 15px; margin-bottom: 20px; border-radius: 6px;">
                <p style="margin: 0; color: #374151; font-weight: 600; font-size: 14px;">📷 Photos Attached: ${data.photos.length} file(s)</p>
              </div>
              ` : ''}
