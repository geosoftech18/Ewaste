        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">S P Recycling Pvt Ltd</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Leading E-Waste Management Company in India, committed to sustainable recycling solutions and environmental protection.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-gray-400">
                ...
                <a href="tel:+919949901238" className="hover:text-emerald-400 transition-colors">(+91) 9949901238</a>
              </li>
              <li className="flex items-start gap-2 text-gray-400">
                <Mail className="w-5 h-5 flex-shrink-0 mt-0.5 text-emerald-400" />
                <a href="mailto:siliconplanetrecycling@gmail.com" className="hover:text-emerald-400 transition-colors break-all">siliconplanetrecycling@gmail.com</a>
              </li>
              <li className="flex items-start gap-2 text-gray-400">
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © 2024 S P Recycling Pvt Ltd. All rights reserved.
            </p>
