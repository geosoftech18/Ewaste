        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
          ...
          <div className="animate-slide-in-left">
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              SP Recycling Pvt Ltd pioneers sustainable e-waste management in Hyderabad. Our cutting-edge facility
              ensures maximum material recovery with zero environmental impact.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 mt-12 pt-8 border-t border-border">
              ...
              <div>
                <div className="text-2xl sm:text-3xl font-bold text-primary">Asia's 1st</div>
                <p className="text-sm text-muted-foreground">LEED Platinum</p>
              </div>
              <div>
                <div className="text-2xl sm:text-3xl font-bold text-primary">Zero Waste</div>
                <p className="text-sm text-muted-foreground">Leakage</p>
              </div>
            </div>
          </div>
